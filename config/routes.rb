...
Rails.application.routes.draw do
  ...
  namespace :api, defaults: { format: :json } do
    namespace :v1 do
      resources :app, except: [:index] do
        member do
          get 'chat', to: "widgets/chat_widget/chats#show"
          post :join_me
          post :disjoin_me
          post 'disjoin/:member_id', to: "app#disjoin"
          match 'member/:member_id', to: "app#member", via: [:put, :patch]
          post 'upload/cover_image', to: 'app#upload_cover_image'
          post 'upload/avatar', to: 'app#upload_avatar'
          get :members
          post :like
          post :unlike
          get :feed
      ...
      get :my_app, to: "app#my_app"
      get :recommended_app, to: "app#recommended_app"

      resource :app_invitation, only: [:create, :update] do
        collection do
          post 'generate/user', to: "app_invitations#generate_user"
        end
      end
