...
import AppScene from './app/App/scenes/AppScene';
...
function isLoggedIn() {
  const currentUser = !!localStorage.getItem('mapp_user');
  const authToken = !!localStorage.getItem('mapp_token');
  const clientId = !!localStorage.getItem('mapp_client_id');
  ...
  childRoutes: [
    ...
    },
    {
      ...
      childRoutes: [
        ...
        { onEnter: requireAuth,
          childRoutes: [
            { path: 'app/:permalink', component: AppScene,
              childRoutes: [
                { path: ':app_tab', component: AppScene,
                  childRoutes: [
                    { path: 'album/:album_id', component: AppScene },
                    { path: 'all-media', component: AppScene },
                  ],
                },
              ],
            },
...
export default (
  <Route path='/'>
    ...
    <Route component={InnerPageLayout} onEnter={requireAuth}>
      ...
      <Route path='app/:permalink' component={AppScene}>
        <Route path=':app_tab' component={AppScene} >
          <Route path='album/:album_id' component={AppScene} />
          <Route path='all-media' component={AppScene} />
        </Route>
      </Route>

    </Route>

    <Route path='myapp-admin' component={AdminPageLayout} onEnter={requireAuth}>
