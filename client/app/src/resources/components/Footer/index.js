      ...
      <div className={`footer ${this.props.className}`}>
        <Grid className='footer_menuitems'>
          <Row>
            <Col xs={12} sm={6} md={3} lg={3}>
              ...
              <a href='#accordion1' id='open-accordion1' className='footer_subheader footer_subheader_1 accordion-title'>Using App</a>
              <a href='#footer_menuitems' id='close-accordion1' className='footer_subheader accordion-title'>Using App</a>
            ...
            <Col xs={12} sm={6} md={3} lg={3}>
              ...
              <Menu desktop className='footer_menu_4 accordion-content'>
                ...
                <MenuItem primaryText='App for Business' className='inactive' disabled />
        ...
        <Row className='footer_copyright'>
          <Col xs={12}>
            <Row center='xs'>
              <Col xs={6} >
                2016 Copyright © MyApp.com - All Rights Reserved.
              </Col>
            </Row>
          </Col>
        </Row>
