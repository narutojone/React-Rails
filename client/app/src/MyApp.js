...
networkInterface.use([{
  applyBatchMiddleware(req, next) {
    ...
    req.options.headers.authorization = localStorage.getItem('mapp_token') ? localStorage.getItem('mapp_token') : null;
    req.options.headers['Client-ID'] = localStorage.getItem('mapp_client_id') ? localStorage.getItem('mapp_client_id') : null;
    next();
  },
},
]);
