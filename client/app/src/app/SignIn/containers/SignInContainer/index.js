  ...
  submitForm = (data) => {
    ...
    this.props.client.mutate({
      ...
      if (errors) {
        ...
        localStorage.setItem('mapp_token', data.signInUser.user.access_token);
        localStorage.setItem('mapp_client_id', data.signInUser.user.client_id);
        localStorage.setItem('mapp_user', JSON.stringify(data.signInUser.user));
