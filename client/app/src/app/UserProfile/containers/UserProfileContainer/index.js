...
import UserApp from '@userprofile/components/UserApp';
...
class UserProfileContainer extends Component {
  ...
  componentWillMount() {
    ...
    const currUser = JSON.parse(localStorage.getItem('mapp_user'));
    ...
    if (this.props.getAnotherUserInfo.loading) {
      ...
      const sidebarContent = <div className='user-profile'>
        <div className='myb-feed-types fixed-types'>
          ...
          <Link
            className={dashTab === 'app' ? 'myb-feed active' : 'myb-feed'}
            to={`/u/${username}/app`}
          >
            <IconApp style={CommonStyles.iconStyle} /><span className='myb-feed-label'>App</span>
          </Link>
        </div>
      </div>;
      ...
      if (this.isFriend() || user.id === currentUser.id) {
        ...
        if (dashTab === 'gallery') {
          ...
          showDashTab = <UserApp app={app.edges} />;
        }
      }
      else {
                    ...
                    <div className='user-main-info'>
                      ...
                      <div className="user-main-stat-info">
                        ...
                        <div className="user-stat-block">
                          <Link
                            to={`/u/${user.username}/app`}
                            className='view-all'
                          >
                            <span className="digit">{app.edges.length}</span> App
                          </Link>
                        </div>
                      </div>
                    </div>
