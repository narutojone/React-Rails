...
class Statistics extends Component {
  ...
  render() {
    ...
    const { appCreateCount, appJoinCount, totalPrivateApp, totalPublicApp } = adminApp;
    ...
    return (
      <div>
        ...
        <h2 style={CommonStyles.pageTitleStyle}>App</h2>
        <table>
          <tbody>
            <tr>
              <td style={CommonStyles.dataTableLabel}>Average number of created app per user:</td>
              <td>{totalUsers ? this.formatFloat(appCreateCount / totalUsers) : 0}</td>
            </tr>
            <tr>
              <td style={CommonStyles.dataTableLabel}>Average number of joined app per user:</td>
              <td>{totalUsers ? this.formatFloat(appJoinCount / totalUsers) : 0}</td>
            </tr>
            <tr><td>
              <div style={{ width: '100%', height: 5 }} />
            </td></tr>
            <tr>
              <td style={CommonStyles.dataTableLabel}>Total public app:</td>
              <td>{totalPublicApp}</td>
            </tr>
            <tr>
              <td style={CommonStyles.dataTableLabel}>Total private app:</td>
              <td>{totalPrivateApp}</td>
            </tr>
          </tbody>
        </table>
