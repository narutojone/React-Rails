...
import IconCommunicationChatApp from 'material-ui/svg-icons/communication/chat-app-outline';
...
class FeedItem extends Component {
  ...
  componentDidMount = () => {
    ...
    /*if (feeditem.object_type !== 'App' && feeditem.object_type !== 'Event') {
      setTimeout(() => {
  ...
  getStatus = () => {
    ...
    if (feednode.name) {
      ...
      else if (feednode.name.substr(0, 7) === 'app') {
        feedObj = feednode.o_app;
      }
  ...
  render() {
    ...
    if (feeditem.name === 'activities.share') {
      ...
      if (feeditem.name === 'app.create') {
        if (feeditem.app) {
          typeMessage = (<span>
            created the app&nbsp;
            <Link key={randomKey} to={`/app/${feedObj.permalink}`}>{feedObj.name}</Link>
          </span>);
        }
        else if (feeditem.o_app) {
          typeMessage = (<span>
            created the app&nbsp;
            <Link key={randomKey} to={`/app/${feeditem.o_app.permalink}`}>{feeditem.o_app.name}</Link>
          </span>);
        }
      }
      else if (feeditem.name === 'app.disjoin_user' || feeditem.name === 'app.join_user') {
        if (this.props.feed_location === 'app_feed') {
      ...
      else if (feeditem.name.substr(0, 7) === 'app') {
        if (this.props.feed_location === 'app_feed') {
          typeMessage = <span>{feednode.user_friendly_name}</span>;
        }
        else if (feeditem.app) {
          typeMessage = (<span>
              {feednode.user_friendly_name} in app&nbsp;
              <Link key={randomKey} to={`/app/${feedObj.permalink}`}>{feedObj.name}</Link>
            </span>);
        }
        else if (feeditem.o_app) {
      ...
      if (feeditem.name === 'galleries.create_album') {
        if (feeditem.app) {
          typeMessage = (<span>
            ...
            <Link
              key={randomKey}
              to={`/app/${feeditem.app.permalink}/gallery/album/${feedObj.id}`}
            >
              {feedObj.name}
            </Link>
            &nbsp;to app&nbsp;
            <Link to={`/app/${feeditem.app.permalink}/gallery/`}>
              {feeditem.app.name}
            </Link>
            &nbsp;gallery
          </span>);
          ...
          typeMessage = (<span>
            ...
            <Link
              key={randomKey}
              to={`/app/${feeditem.o_app.permalink}/gallery/album/${feedObj.id}`}
            >
              {feedObj.name}
            </Link>
            &nbsp;to app&nbsp;
          ...
          typeMessage = <span>added a new album to app gallery</span>;
        }
      }
      if (feeditem.name === 'albums.create') {
      ...
      if (feeditem.name === 'albums.create_media' || feeditem.name === 'galleries.create_media') {
        if (feeditem.app) {
          typeMessage = (<span>
            added to gallery in app&nbsp;
            <Link key={randomKey} to={`/app/${feeditem.app.permalink}/gallery`}>
              {feeditem.app.name}
            </Link>
          </span>);
        }
          ...
          typeMessage = (<span>
            added to gallery in app&nbsp;
            <Link key={randomKey} to={`/app/${feeditem.o_app.permalink}/gallery`}>
              {feeditem.o_app.name}
            </Link>
          </span>);
        }
      ...
      if (feeditem.name === 'blogs.create_post' || feeditem.object_type === 'Widgets::BlogWidget::Post') {
        if (this.props.feed_location === 'app_feed' || this.props.feed_location === 'blog_feed') {
          typeMessage = <span>in blog</span>;
        }
        else if (feednode.app) {
          typeMessage = (<span>
              in app&nbsp;
              <Link key={randomKey} to={`/app/${feeditem.app.permalink}/blog`}>
                {feednode.app.name}
              </Link>
            </span>);
        }
        else if (feednode.o_app) {
          typeMessage = (<span>
              in app&nbsp;
              <Link key={randomKey} to={`/app/${feeditem.o_app.permalink}/blog`}>
                {feednode.o_app.name}
              </Link>
            </span>);
        }
        else {
          typeMessage = <span>in app</span>;
        }
      }
      if (feeditem.name === 'events.create') {
        if (feedObj) {
          if (this.props.feed_location === 'app_feed') {
            typeMessage = <span>created event <strong>{feedObj.name}</strong> in app</span>;
          }
          else {
            typeMessage = (<span>
              created event&nbsp;
              ...
              &nbsp;in app&nbsp;
              <Link key={randomKey} to={`/app/${feeditem.app.permalink}/events`}>
                {feednode.app.name}
              </Link>
            </span>);
          }
    ...
    if (feeditem.name === 'albums.create'
      ...
      feedContent = <div className='message-content app-item'>
        {
          feedObj.avatar_url ?
      ...
      feedContent = <div className='message-content app-item'>
        {
          feedObj.avatar_url ?
            <Link to={`/app/${feeditem.app.permalink}/gallery/album/${feedObj.id}`}>
              <img className='message-photo' src={feedObj.avatar_url} role='presentation' />
            </Link>
          :
          ''
    ...
    else if (feeditem.name === 'app.create' ||
      feeditem.name === 'app.upload_avatar' ||
      feeditem.object_type === 'App') {
      feedContent = '';
    }
    else if (feeditem.name === 'app.disjoin_user' ||
      feeditem.name === 'app.join_user' ||
      feeditem.object_type === 'App') {
      feedContent = '';
    }
      ...
      feedContent = (<div className='message-content app-item'>
        ...
        <div className='app-description' style={{ marginLeft: 110 }}>
      ...
      feedStat = <div className='message-stats'>
        ...
        >
          <IconCommunicationChatApp style={{ width: 22, height: 22, ...CommonStyles.iconStyle }} color={commentColor} />
              ...
              >
                {
                  (
                    ...
                    this.props.feed_location === 'app_feed' ||
