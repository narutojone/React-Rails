...
class AddAppWidget extends Component {
  ...
  handleAddWidget = () => {
    ...
    this.props.addAppWidget({ variables: {
      app_id: parseInt(this.props.app.id),
      name: widget,
    } })
    .then((graphQLResult) => {
...
export default hoc(AddAppWidget);
