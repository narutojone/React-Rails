...
class GalleryAlbum extends Component {
  ...
  submitForm = (data) => {
    ...
    if (this.props.gallery_id) {
      req_video.set('Authorization', localStorage.getItem('mapp_token'));
      req_video.set('Client-ID', localStorage.getItem('mapp_client_id'));
    ...
    if (this.props.gallery_id) {
      req_image.set('Authorization', localStorage.getItem('mapp_token'));
      req_image.set('Client-ID', localStorage.getItem('mapp_client_id'));
  ...
  render() {
    ...
    if (this.props.data.loading) {
      ...
      if (this.props.username) {
        ...
        backLink = <Link to={'/app/' + this.props.permalink + '/gallery'}>Go back to App Albums</Link>;
      }
