        ...
        secondaryText={
          <span>
            ...
            <div>
              ...
              <span style={CommonStyles.userApp.statStyle}>{event.members_count}</span>
              <IconActionFavorite color={CommonStyles.userApp.grayColor} style={{ ...CommonStyles.userApp.iconStyle, marginLeft: 10, marginRight: 5 }} />
              <span style={CommonStyles.userApp.statStyle}>{event.likes_count}</span>
            </div>
          </span>
        }
        rightIcon={
          <span className='app-actions' style={{ height: 40, top: 0, width: 'auto', margin: '20px 0', textAlign: 'right' }}>
            {
