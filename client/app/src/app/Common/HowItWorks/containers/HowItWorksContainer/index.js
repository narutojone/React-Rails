...
class HowItWorksContainer extends Component {
  ...
  render() {
    ...
    const app = <div id='app'>
      ...
      <div className='app x22' />
      <div className='app x23' />
      <div className='app x24' />
      <div className='app x25' />
      <div className='app x26' />
      <div className='app x27' />
      <div className='app x28' />
      <div className='app x29' />
      <div className='app x290' />
      <div className='app x291' />
    </div>;
          ...
          <div className='welcome-wrapper purplebg'>
            <div className='container'>
                <div className='introsection'>
                  <h1>See How <b>MyApp</b> Keeps You <b>Private</b></h1>
          ...
          <div className='lt-wrapper'>
            <div className='features-overview'>
              <div className='features-slider'>
                <TabsControl>
                  <Tab name='Private app' src='/assets/how_it_works/lock.png'>
                    <div className='description'>
                      Keep your content private between users. What you share in private app can only be viewed by
                      those who are also member of that app. Share the content of your virtual life the same way you do in real life.
                    </div>
                    <div className='illustration-wrapper'>
                      <div className='illustration-body grey' />
                    </div>
                  </Tab>
                  <Tab name='Public app' src='/assets/how_it_works/app.png'>
                    <div className='description'>
                      Create app that relate to your interests. Let others around you or anywhere find, join and
                      participate in your app.
                    </div>
                    <div className='illustration-wrapper'>
                  ...
                  <Tab name='Customizable widgets' src='/assets/how_it_works/widget.png'>
                    <div className='description'>
                      Widgets provide your app such powerful tools as file sharing, whiteboard, video and text chat,
                ...
                <div className='special-wrapper'>
                  ...
                  <div className='special-description'>
                    ...
                    <div className='special-body'>
                      ...
                      benefit from all those services in one place - one login, one app, multiple widgets. Keep your life and business organized but separated with increase productivity receiving notifications from your widgets all in one location.
                    </div>
                    <div className='special-join'>
                      <Link to={'/'}>Join Myapp <span>▶</span></Link>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className='lt-wrapper'>
            <div className='additional-overview'>
              <div className='private-feature'>
                ...
                <p>
                  Your profile will not be searchable by search engines and we only ask for your first name during registration. Other users cannot search you by your name and your private content is hidden from others unless they are in the same private app.
                </p>
              </div>
