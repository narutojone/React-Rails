class ApplicationController < ActionController::Base
  ...
  def user_api_controller?
    devise_controller? or (controller_path =~ /\Aapi\/v1\// and !show_app_with_token)
  end

  def show_app_with_token
    (params[:controller] == 'api/v1/app') and (params[:action] == 'show') and (params[:new_member_token].present?)
  end
